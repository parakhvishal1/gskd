    ...
    $("#content_box").append(`
        <div class="splash_screen">
            ...
            <div class="legal_tnc">
                ...
                <div class="legal_tnc_body">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
                    praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint
                    occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia.</div>
                <div class="readmore">Read More</div>
            </div>
        </div>
        <div class="copyright">©2022 GSK. All Rights Reserved.</div>
    `);
}
        ...
        <div class="termsofuse">
            <div class="main_content">
                ...
                <div class="termsofuse_content">
                    <div class="block">
                        ...
                        <div class="detail">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui offiserunt mollitia animi.</div>
                    </div>
                    <div class="block">  
                        <div class="title">Authorization</div>
                        <div class="detail">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt laboret.</div>  
                    </div>
                    <div class="block">    
                        <div class="title">Privacy Policy</div>
                        <div class="detail">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui offiserunt mollitia animi.</div>
                    ...
                    <div class="block">    
                        <div class="title">Collection And Use Of Information</div>
                        <div class="detail">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui.</div>
                    </div>
                    <div class="block">   
                        <div class="title">Use Of Your Personal Data</div>
                        <div class="detail">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum.</div>
                    </div>
                </div>
            </div>
            <div class="btn_wrapper">
                <div class="btnbox">
                    ...
                    <button class="btn solid">Accept the terms</button>
                </div>
            </div>
            <div class="copyright">©2022 GSK. All Rights Reserved.</div>
        </div>
